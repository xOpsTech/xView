...
this.dashboardurl = this.sanitizer.bypassSecurityTrustResourceUrl(config.elasticsearchurl+":5601/app/kibana#/dashboard/c0dba1b0-3164-11e8-8439-59fbc416b7aa?_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-15m,interval:'1m',mode:quick,timezone:Asia%2FKolkata,to:now))&_a=(description:'',filters:!(),options:(darkTheme:!f),panels:!((col:1,id:b3f4dde0-3164-11e8-8439-59fbc416b7aa,panelIndex:1,row:3,size_x:6,size_y:3,type:visualization),(col:7,id:ff3db720-3166-11e8-8439-59fbc416b7aa,panelIndex:2,row:3,size_x:6,size_y:3,type:visualization),(col:1,id:'1e253420-3166-11e8-8439-59fbc416b7aa',panelIndex:3,row:6,size_x:6,size_y:3,type:visualization),(col:1,id:'7bbf7ea0-3167-11e8-8439-59fbc416b7aa',panelIndex:4,row:1,size_x:12,size_y:2,type:visualization),(col:7,id:'7f6b3e00-3166-11e8-8439-59fbc416b7aa',panelIndex:5,row:6,size_x:6,size_y:3,type:visualization),(col:1,id:b8281560-3166-11e8-8439-59fbc416b7aa,panelIndex:6,row:9,size_x:12,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'_index:%22metrics-" +  this.tenantId + "%22')),timeRestore:!t,title:newRelic,uiState:(P-4:(vis:(params:(sort:(columnIndex:!n,direction:!n))))),viewMode:view)");
